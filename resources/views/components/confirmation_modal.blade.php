@if ($confirmDelete)
    <div x-data="{ open: @entangle('confirmDelete'), loading: false }" x-show="open" @keydown.escape.window="open = false"
        ...
        <div class="bg-gray-800 p-8 py-5 rounded-lg shadow-lg max-w-sm w-full text-center">
            ...
            <!-- Message section -->
            <h2 x-show="!loading" class="text-lg text-white mb-4 text-center">
            ...
            <div class="flex justify-between mt-5">
                ...
                <button x-show="!loading" @click="loading = true; $wire.deleteUser().then(() => { 
                        loading = false; 
                        showModal = true; // Re-open modal for notification
